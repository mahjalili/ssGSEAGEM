clear all;
organism = 'Yeast';
data = readtable(['ssGSEA/GSE8895/ssGSEA',organism,'.csv'],'ReadRowNames',true);
DatassGSEAw = bioma.data.DataMatrix(data{:,:}, data.Properties.RowNames, data.Properties.VariableNames);
load('datasets/GSE8895/GIMME/Data.mat');
load(['datasets/GSE8895/ssGSEA/subSysStat',organism,'.mat']);
...
save(['datasets/GSE8895/ssGSEA/DatassGSEA',type,'.mat'], 'DatassGSEA');
%%
clear expRxns;
dataset = struct();
...
save(['datasets/GSE8895/ssGSEA/expRxns',organism,'.mat'], 'expRxns');
