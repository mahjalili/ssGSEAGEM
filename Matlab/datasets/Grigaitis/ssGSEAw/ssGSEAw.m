...
type = 'Yeast';
%%
data = readtable(['ssGSEA/ssGSEA',type,'.csv'],'ReadRowNames',true);
...
load(['datasets/ssGSEAw/subSysStat',type,'.mat']);
...
save(['datasets/ssGSEAw/DatassGSEAw',type,'.mat'], 'DatassGSEAw');
...
save(['datasets/ssGSEAw/expRxns',type,'.mat'], 'expRxns');
